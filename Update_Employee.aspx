<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update_Employee.aspx.cs" Inherits="Update_Employee" %>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="search">
                ...
                <asp:Label ID="lblSearch" CssClass="lblline" runat="server" Text="Enter Employee ID"></asp:Label>
                <asp:TextBox ID="txtSearchID" CssClass="txtline" placeholder="Enter Employee ID" runat="server" ></asp:TextBox>
            ...
            <div class="container">
                <div class="title">Update Employee Information</div>
                <div class="user-details">
                    <div class="input-box">
                        <asp:Label ID="Label16" CssClass="span" runat="server" Text="Enter Employee ID"></asp:Label>
                        <asp:TextBox ID="txtid" type="text" CssClass="input" placeholder="Enter First ID" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <asp:TextBox ID="txtDOB" type="text" CssClass="input" placeholder="DD-MM-YYYY" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <asp:TextBox ID="txtStartingDate" type="text" CssClass="input" placeholder="DD-MM-YYYY" runat="server" ReadOnly="True"></asp:TextBox>
                    </div>
                    <div class="input-box">
