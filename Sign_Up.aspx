...
<body>
    ...
    <div class="wrapper fadeInDown">
      <div id="formContent">
        ...
        <!-- Login Form -->
        <form runat="server">
            <asp:TextBox type="text" ID="Username" placeholder="Enter Username" runat="server"></asp:TextBox>
            <asp:TextBox type="text" ID="email" placeholder="Enter Email" runat="server"></asp:TextBox>
            <asp:TextBox CssClass="text" ID="password" placeholder="Enter Password" TextMode="Password" runat="server"></asp:TextBox>
            <asp:TextBox CssClass="text" ID="Rpassword" placeholder="Re-Enter Password" TextMode="Password" runat="server"></asp:TextBox>
        ...
        <!-- Remind Passowrd-->
        <div id="formFooter">
          <a class="underlineHover" href="Log In.aspx">Login in</a>
        </div>
