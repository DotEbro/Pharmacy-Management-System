...
public partial class P_Low_Stock : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (index[0] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[0]].ToString();
            lbEXP1.Text = "EXP Date: " + EXPdate[index[0]];
            lbRemaning1.Text = "Threshold (in Box): 20";
        }
        if (index[1] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[1]].ToString();
            lbEXP2.Text = "EXP Date: " + EXPdate[index[1]];
            lbRemaning2.Text = "Threshold (in Box): 20";
        }
        if (index[2] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[2]].ToString();
            lbEXP3.Text = "EXP Date: " + EXPdate[index[2]];
            lbRemaning3.Text = "Threshold (in Box): 20";
        }
        if (index[3] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[3]].ToString();
            lbEXP4.Text = "EXP Date: " + EXPdate[index[3]];
            lbRemaning4.Text = "Threshold (in Box): 20";
        }
        if (index[4] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[4]].ToString();
            lbEXP5.Text = "EXP Date: " + EXPdate[index[4]];
            lbRemaning5.Text = "Threshold (in Box): 20";
        }
        if (index[5] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[5]].ToString();
            lbEXP6.Text = "EXP Date: " + EXPdate[index[5]];
            lbRemaning6.Text = "Threshold (in Box): 20";
        }
    ...
    protected void btn2_Click(object sender, EventArgs e)
    {
        if (index[6] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[6]].ToString();
        ...
        if (index[7] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[7]].ToString();
        ...
        if (index[8] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[8]].ToString();
        ...
        if (index[9] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[9]].ToString();
        ...
        if (index[10] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[10]].ToString();
        ...
        if (index[11] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[11]].ToString();
    ...
    protected void btn3_Click(object sender, EventArgs e)
    {
        if (index[12] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[12]].ToString();
        ...
        if (index[13] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[13]].ToString();
        ...
        if (index[14] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[14]].ToString();
        ...
        if (index[15] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[15]].ToString();
        ...
        if (index[16] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[16]].ToString();
        ...
        if (index[17] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[17]].ToString();
    ...
    protected void btn4_Click(object sender, EventArgs e)
    {
        if (index[18] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[18]].ToString();
        ...
        if (index[19] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[19]].ToString();
        ...
        if (index[20] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[20]].ToString();
        ...
        if (index[21] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[21]].ToString();
        ...
        if (index[22] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[22]].ToString();
        ...
        if (index[23] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[23]].ToString();
    ...
    protected void btn5_Click(object sender, EventArgs e)
    {
        if (index[24] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[24]].ToString();
        ...
        if (index[25] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[25]].ToString();
        ...
        if (index[26] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[26]].ToString();
        ...
        if (index[27] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[27]].ToString();
        ...
        if (index[28] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[28]].ToString();
        ...
        if (index[29] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[29]].ToString();
    ...
    protected void btn6_Click(object sender, EventArgs e)
    {
        if (index[30] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[30]].ToString();
        ...
        if (index[31] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[31]].ToString();
        ...
        if (index[32] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[32]].ToString();
        ...
        if (index[33] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[33]].ToString();
        ...
        if (index[34] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[34]].ToString();
        ...
        if (index[35] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[35]].ToString();
    ...
    protected void btn7_Click(object sender, EventArgs e)
    {
        if (index[36] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[36]].ToString();
        ...
        if (index[37] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[37]].ToString();
        ...
        if (index[38] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[38]].ToString();
        ...
        if (index[39] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[39]].ToString();
        ...
        if (index[40] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[40]].ToString();
        ...
        if (index[41] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[41]].ToString();
    ...
    protected void btn8_Click(object sender, EventArgs e)
    {
        if (index[42] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[42]].ToString();
        ...
        if (index[43] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[43]].ToString();
        ...
        if (index[44] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[44]].ToString();
        ...
        if (index[45] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[45]].ToString();
        ...
        if (index[46] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[46]].ToString();
        ...
        if (index[47] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[47]].ToString();
    ...
    protected void btn9_Click(object sender, EventArgs e)
    {
        if (index[48] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[48]].ToString();
        ...
        if (index[49] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[49]].ToString();
        ...
        if (index[50] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[50]].ToString();
        ...
        if (index[51] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[51]].ToString();
        ...
        if (index[52] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[52]].ToString();
        ...
        if (index[53] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[53]].ToString();
    ...
    protected void btn10_Click(object sender, EventArgs e)
    {
        if (index[54] != -1)
        {
            ...
            lbQuantity1.Text = "Remaning Quantity: " + Quantity[index[54]].ToString();
        ...
        if (index[55] != -1)
        {
            ...
            lbQuantity2.Text = "Remaning Quantity: " + Quantity[index[55]].ToString();
        ...
        if (index[56] != -1)
        {
            ...
            lbQuantity3.Text = "Remaning Quantity: " + Quantity[index[56]].ToString();
        ...
        if (index[57] != -1)
        {
            ...
            lbQuantity4.Text = "Remaning Quantity: " + Quantity[index[57]].ToString();
        ...
        if (index[58] != -1)
        {
            ...
            lbQuantity5.Text = "Remaning Quantity: " + Quantity[index[58]].ToString();
        ...
        if (index[59] != -1)
        {
            ...
            lbQuantity6.Text = "Remaning Quantity: " + Quantity[index[59]].ToString();
