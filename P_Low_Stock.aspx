<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P_Low_Stock.aspx.cs" Inherits="P_Low_Stock" %>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="P_Low_Stock.aspx" class="active"><span class="las la-download"></span><span>Low Stock</span></a>
                </li>
                <li>
    ...
    <div class="main-content">
        ...
        <main>
                ...
                <div class="Two-Card">
                    <div class="Single-card">
                        <div>
                            ...
                            <asp:Label ID="lbEXP1"  runat="server" Text=""></asp:Label><br />
                        </div>
                        <div class="EXP-side">
                            <asp:Label ID="lbQuantity1" CssClass="Red" runat="server" Text=""></asp:Label><br />
                   ...
                   <div class="Single-card">
                       <div>
                            ...
                            <asp:Label ID="lbEXP2"  runat="server" Text=""></asp:Label><br />
                        </div>
                        <div class="EXP-side">
                            <asp:Label ID="lbQuantity2" CssClass="Red" runat="server" Text=""></asp:Label><br />
                ...
                <div class="Two-Card">
                    <div class="Single-card">
                        <div>
                            ...
                            <asp:Label ID="lbEXP3"  runat="server" Text=""></asp:Label><br />

                        </div>
                        <div class="EXP-side">
                            <asp:Label ID="lbQuantity3" CssClass="Red" runat="server" Text=""></asp:Label><br />
                    ...
                    <div class="Single-card">
                        <div>
                            ...
                            <asp:Label ID="lbEXP4" runat="server" Text=""></asp:Label><br />
                        </div>
                        <div class="EXP-side">
                            
                            <asp:Label ID="lbQuantity4" CssClass="Red" runat="server" Text=""></asp:Label><br />
                ...
                <div class="Two-Card">
                    <div class="Single-card">
                        <div>
                            ...
                            <asp:Label ID="lbEXP5" runat="server" Text=""></asp:Label><br />
                        </div>
                        <div class="EXP-side">
                            
                            <asp:Label ID="lbQuantity5" CssClass="Red" runat="server" Text=""></asp:Label><br />
                    ...
                    <div class="Single-card">
                        <div>
                            ...
                            <asp:Label ID="lbEXP6" runat="server" Text=""></asp:Label><br />
                        </div>
                        <div class="EXP-side">
                            
                            <asp:Label ID="lbQuantity6" CssClass="Red" runat="server" Text=""></asp:Label><br />
            ...
            <div class="btn-div">
                <asp:Button ID="btn1" runat="server" CssClass="btn" Text="1" Visible="false" />
                <asp:Button ID="btn2" runat="server" CssClass="btn" Text="2" Visible="false" />
                <asp:Button ID="btn3" runat="server" CssClass="btn" Text="3" Visible="false" />
                <asp:Button ID="btn4" runat="server" CssClass="btn" Text="4" Visible="false" />
                <asp:Button ID="btn5" runat="server" CssClass="btn" Text="5" Visible="false" />
                <asp:Button ID="btn6" runat="server" CssClass="btn" Text="6" Visible="false" />
                <asp:Button ID="btn7" runat="server" CssClass="btn" Text="7" Visible="false" />
                <asp:Button ID="btn8" runat="server" CssClass="btn" Text="8" Visible="false" />
                <asp:Button ID="btn9" runat="server" CssClass="btn" Text="9" Visible="false" />
                <asp:Button ID="btn10" runat="server" CssClass="btn" Text="10" Visible="false"  />
            </div>
        </main>
    </div>
    </form>
