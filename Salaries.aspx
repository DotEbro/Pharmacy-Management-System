    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="Salaries.aspx" class="active"><span class="las la-wallet"></span><span>View Salaries</span></a>
                </li>
                <li>
            ...
            <div class="gridView">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="emp_id" DataSourceID="SqlDataSource1">
                    <Columns>
                        ...
                        <asp:BoundField DataField="emp_startdate" HeaderText="Starting Date" SortExpression="emp_startdate" />
                        <asp:BoundField DataField="emp_qualification" HeaderText="Qualification" SortExpression="emp_qualification" />
                        <asp:BoundField DataField="emp_jobtitle" HeaderText="Job Title" SortExpression="emp_jobtitle" />
                        <asp:BoundField DataField="emp_salary" HeaderText="Salary" SortExpression="emp_salary" />
                        <asp:BoundField DataField="emp_jobstatus" HeaderText="Job Status" SortExpression="emp_jobstatus" />
                    </Columns>
                </asp:GridView>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CareFareConnectionString %>" SelectCommand="SELECT [emp_id], [emp_FName], [emp_LName], [emp_contact], [emp_startdate], [emp_qualification], [emp_jobtitle], [emp_salary], [emp_jobstatus] FROM [Employee]"></asp:SqlDataSource>
            </div>
        </main>
    </div>
    </form>
