<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Modify_Product.aspx.cs" Inherits="Modify_Product" %>
    ...
    <style>
        ...
        *{
        ...
        .txtline{
            ...
            border-radius:5px;
            border: 2px solid var(--form-back);
        }
        .lblline{
            color: #fff;
        }
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="search">
                ...
                <asp:Label ID="lblSearch" CssClass="lblline" runat="server" Text="Enter Product ID"></asp:Label>
                <asp:TextBox ID="txtSearchID" CssClass="txtline" placeholder="Enter Product ID" runat="server" ></asp:TextBox>
                <asp:Button ID="btnSearch" CssClass="btnline" runat="server" Text="Search" OnClick="btnSearch_Click"  />
                <asp:Button ID="btnBack" CssClass="btnline" runat="server" Text="Back" OnClick="btnBack_Click"  />

            </div>

            <div class="container">
                 <div class="title">Modify Product</div>
                <div class="user-details">
                    <div class="input-box">
                        <asp:Label ID="Label16" CssClass="span" runat="server" Text="Enter Product ID"></asp:Label>
                        <asp:TextBox ID="txtPid" type="number" CssClass="input" ReadOnly="true" BackColor="Gray" placeholder="Product ID" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <asp:TextBox ID="txtMFGdate" type="text" CssClass="input" ReadOnly="true" BackColor="Gray" placeholder="DD-MM-YYYY" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-box">
                        <asp:Label ID="Label4" CssClass="span" runat="server" Text="Expire date"></asp:Label>
                        <asp:TextBox ID="txtEXPdate" type="text" CssClass="input" ReadOnly="true" BackColor="Gray" placeholder="DD-MM-YYYY" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <asp:TextBox ID="txtQuantity" type="text" CssClass="input" placeholder="Enter Quantity" runat="server"></asp:TextBox>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="Btn">
                        <div>
                            <asp:Button ID="btnAddP" CssClass="BtnAdd" runat="server" Text="Update" OnClick="btnAddP_Click" />
                        </div>
                        <div>
